...
Denomination.create(money: "Bs.D", power: 0.5, quantity: 0, category: 'CASH', ammount: nil, label: '1000 COP', quadre_id: 1)
Denomination.create(money: "Bs.D", power: 1.0, quantity: 0, category: 'CASH', ammount: nil, label: '2000 COP', quadre_id: 1)
Denomination.create(money: "Bs.D", power: 5.0, quantity: 0, category: 'CASH', ammount: nil, label: '5000 COP', quadre_id: 1)
Denomination.create(money: "Bs.D", power: 10.0, quantity: 0, category: 'CASH', ammount: nil, label: '10.000 COP', quadre_id: 1)
Denomination.create(money: "Bs.D", power: 20.0, quantity: 0, category: 'CASH', ammount: nil, label: '20.000 COP', quadre_id: 1)
Denomination.create(money: "Bs.D", power: 50.0, quantity: 0, category: 'CASH', ammount: nil, label: '50.000 COP', quadre_id: 1)
Denomination.create(money: "Bs.D", power: 100.0, quantity: 0, category: 'CASH', ammount: nil, label: '100.000 COP', quadre_id: 1)
Denomination.create(money: "Bs.D", power: nil, quantity: nil, category: 'TRANSFER', ammount: 0.0, label: 'Transferencia', quadre_id: 1)
Denomination.create(money: "Bs.D", power: nil, quantity: 0, category: 'TRANSFER', ammount: 0.0, label: 'Sencillo', quadre_id: 1)
Denomination.create(money: "Bs.D", power: nil, quantity: 0, category: 'DEBT', ammount: 0.0, label: 'Gastos', quadre_id: 1)

Denomination.create(money: "$", power: 0.5, quantity: 0, category: 'CASH', ammount: nil, label: '1000 COP', quadre_id: 1)
Denomination.create(money: "$", power: 1.0, quantity: 0, category: 'CASH', ammount: nil, label: '2000 COP', quadre_id: 1)
Denomination.create(money: "$", power: 5.0, quantity: 0, category: 'CASH', ammount: nil, label: '5000 COP', quadre_id: 1)
Denomination.create(money: "$", power: 10.0, quantity: 0, category: 'CASH', ammount: nil, label: '10.000 COP', quadre_id: 1)
Denomination.create(money: "$", power: 20.0, quantity: 0, category: 'CASH', ammount: nil, label: '20.000 COP', quadre_id: 1)
Denomination.create(money: "$", power: 50.0, quantity: 0, category: 'CASH', ammount: nil, label: '50.000 COP', quadre_id: 1)
Denomination.create(money: "$", power: 100.0, quantity: 0, category: 'CASH', ammount: nil, label: '100.000 COP', quadre_id: 1)
Denomination.create(money: "$", power: nil, quantity: nil, category: 'TRANSFER', ammount: 0.0, label: 'Transferencia', quadre_id: 1)
Denomination.create(money: "$", power: nil, quantity: 0, category: 'TRANSFER', ammount: 0.0, label: 'Sencillo', quadre_id: 1)
Denomination.create(money: "$", power: nil, quantity: 0, category: 'DEBT', ammount: 0.0, label: 'Gastos', quadre_id: 1)
